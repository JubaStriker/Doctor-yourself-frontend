        ...
        <div className='my-28'>
            ...
            <div className='flex flex-col md:flex-row-reverse justify-center items-center'>
                <div className='relative w-1/2'>
                    ...
                    <img src="https://media.istockphoto.com/id/961730934/photo/vegetarian-buddha-bowl-with-quinoa-and-fresh-vegetables-healthy-food-concept-vegan-salad-top.jpg?s=612x612&w=0&k=20&c=0r2VgC4VrKsSSafr-fQRiTWSntjEJdZOUJtlRN3d1qE=" alt='' className="border-10 w-3/5 left-36 top-[35%] absolute rounded-lg shadow-2xl" />
                </div>
                <div>
